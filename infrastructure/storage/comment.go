...
// UploadCommentMedia uploads the commentFile to Cloudinary as the comment's storage,
// using the commentID as the file name.
...
func (f file) UploadCommentMedia(commentID string, commentFile io.Reader, typeMedia string) (commentURL string, err error) {
...
// DeleteCommentMedia deletes the comment's media file from Cloudinary storage.
func (f file) DeleteCommentMedia(commentID string) error {
